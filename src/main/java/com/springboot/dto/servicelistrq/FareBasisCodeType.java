...
@XmlSeeAlso({
    com.springboot.dto.servicelistrq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.servicelistrq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
