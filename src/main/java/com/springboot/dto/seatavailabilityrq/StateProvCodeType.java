...
@XmlSeeAlso({
    com.springboot.dto.seatavailabilityrq.StateProvQueryType.StateCodes.StateCode.class,
    com.springboot.dto.seatavailabilityrq.StateProvProximityType.StateCode.class
})
