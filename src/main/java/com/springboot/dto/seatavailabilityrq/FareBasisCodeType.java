...
@XmlSeeAlso({
    com.springboot.dto.seatavailabilityrq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.seatavailabilityrq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
