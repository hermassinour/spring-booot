...
@XmlSeeAlso({
    com.springboot.dto.orderreshoprq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.orderreshoprq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
