...
@XmlSeeAlso({
    ...
    com.springboot.dto.orderreshoprq.V172PenaltyType.ApplicableFeeRemarks.class,
    com.springboot.dto.orderreshoprq.V172PenaltyType.Details.Detail.Amounts.Amount.ApplicableFeeRemarks.class
})
