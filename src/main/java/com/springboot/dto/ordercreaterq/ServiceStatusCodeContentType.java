...
/**
 * <p>Java class for ServiceStatusCodeContentType.
 * 
 ...
 * 
 */
@XmlType(name = "ServiceStatusCodeContentType")
@XmlEnum
public enum ServiceStatusCodeContentType {
    ...
    ServiceStatusCodeContentType(String v) {
        value = v;
    }
    ...
    public static ServiceStatusCodeContentType fromValue(String v) {
        for (ServiceStatusCodeContentType c: ServiceStatusCodeContentType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
