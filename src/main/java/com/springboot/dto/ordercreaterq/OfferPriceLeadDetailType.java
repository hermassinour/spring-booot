 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.ordercreaterq.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ", type = JAXBElement.class, required = false),
