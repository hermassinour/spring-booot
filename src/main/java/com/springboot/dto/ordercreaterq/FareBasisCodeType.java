...
@XmlSeeAlso({
    com.springboot.dto.ordercreaterq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.ordercreaterq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
