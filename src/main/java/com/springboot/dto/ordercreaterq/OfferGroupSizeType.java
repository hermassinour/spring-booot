...
public class OfferGroupSizeType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Minimum", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Maximum", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ", type = JAXBElement.class, required = false)
    })
