 ...
 *       &lt;sequence&gt;
 *         &lt;element name="OriginDestID" type="{http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ}ID_Type" minOccurs="0"/&gt;
 *         &lt;element name="OriginCode" type="{http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ}IATA_LocationCodeType"/&gt;
 *         &lt;element name="DestCode" type="{http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ}IATA_LocationCodeType"/&gt;
 *         &lt;element name="PaxJourneyRefID" type="{http://www.iata.org/IATA/2015/00/2018.1/OrderCreateRQ}ID_Type" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OriginDestType {
    ...
    protected IATALocationCodeType originCode;
    @XmlElement(name = "DestCode", required = true)
    protected IATALocationCodeType destCode;
     ...
     *     
     */
    public IATALocationCodeType getOriginCode() {
        return originCode;
    }
     ...
     *     
     */
    public void setOriginCode(IATALocationCodeType value) {
     ...
     *     
     */
    public IATALocationCodeType getDestCode() {
        return destCode;
    }
     ...
     *     
     */
    public void setDestCode(IATALocationCodeType value) {
        this.destCode = value;
    }
