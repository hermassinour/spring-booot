 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/OrderCancelRQ}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.ordercancelrq.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderCancelRQ", type = JAXBElement.class, required = false),
