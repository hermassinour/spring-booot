...
@XmlSeeAlso({
    com.springboot.dto.ordercancelrq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.ordercancelrq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
