...
/**
 * <p>Java class for AgencyTypeCodeContentType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>
 * &lt;simpleType name="AgencyTypeCodeContentType"&gt;
 ...
 * 
 */
@XmlType(name = "AgencyTypeCodeContentType")
@XmlEnum
public enum AgencyTypeCodeContentType {
    ...
    AgencyTypeCodeContentType(String v) {
        value = v;
    }
    ...
    public static AgencyTypeCodeContentType fromValue(String v) {
        for (AgencyTypeCodeContentType c: AgencyTypeCodeContentType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
