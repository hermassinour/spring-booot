...
@XmlSeeAlso({
    com.springboot.dto.ordercancelrs.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.ordercancelrs.GroupFarePreferencesType.GroupFare.FareBasis.class
})
