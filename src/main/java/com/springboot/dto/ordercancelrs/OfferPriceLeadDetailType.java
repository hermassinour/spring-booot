 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/OrderCancelRS}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.ordercancelrs.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderCancelRS", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "SegmentReferences", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderCancelRS", type = SegmentReferences.class, required = false)
        })
