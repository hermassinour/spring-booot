...
@XmlSeeAlso({
    com.springboot.dto.orderreshoprs.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.orderreshoprs.GroupFarePreferencesType.GroupFare.FareBasis.class
})
