...
@XmlSeeAlso({
    ...
    com.springboot.dto.orderreshoprs.V172PenaltyType.ApplicableFeeRemarks.class,
    com.springboot.dto.orderreshoprs.V172PenaltyType.Details.Detail.Amounts.Amount.ApplicableFeeRemarks.class
})
