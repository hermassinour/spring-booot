...
@XmlSeeAlso({
    com.springboot.dto.orderretrieverq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.orderretrieverq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
