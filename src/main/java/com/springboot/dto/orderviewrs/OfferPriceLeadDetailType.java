 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/OrderViewRS}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.orderviewrs.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderViewRS", type = JAXBElement.class, required = false),
