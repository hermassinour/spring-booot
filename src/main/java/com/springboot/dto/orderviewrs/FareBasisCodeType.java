...
@XmlSeeAlso({
    com.springboot.dto.orderviewrs.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.orderviewrs.GroupFarePreferencesType.GroupFare.FareBasis.class
})
