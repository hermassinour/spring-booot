 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/OfferPriceRS}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.offerpricers.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OfferPriceRS", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "SegmentReferences", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OfferPriceRS", type = SegmentReferences.class, required = false)
        })
