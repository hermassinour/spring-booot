 ...
 *         &lt;element name="SelectedService" type="{http://www.iata.org/IATA/2015/00/2018.1/OrderChangeRQ}RequestedServiceType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlSeeAlso({
    com.springboot.dto.orderchangerq.OrderRequestType.Offer.OfferItem.ServiceSelection.class
})
