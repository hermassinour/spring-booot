 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/OrderChangeRQ}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.orderchangerq.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderChangeRQ", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "SegmentReferences", namespace = "http://www.iata.org/IATA/2015/00/2018.1/OrderChangeRQ", type = SegmentReferences.class, required = false)
        })
