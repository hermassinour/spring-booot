...
@XmlSeeAlso({
    com.springboot.dto.orderchangerq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.orderchangerq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
