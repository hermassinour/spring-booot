 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SeatProfileID" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}ID_Type"/&gt;
 *         &lt;element name="CharacteristicCode" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}CodeType" maxOccurs="99" minOccurs="0"/&gt;
 *         &lt;element name="SeatWidthMeasure" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}MeasureType" minOccurs="0"/&gt;
 *         &lt;element name="SeatPitchMeasure" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}MeasureType" minOccurs="0"/&gt;
 *         &lt;element name="DescText" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}TextType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="MarketingInformation" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}DescType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SeatKeywords" type="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}DiscountContextType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SeatProfileType {
    ...
    protected List<DiscountContextType> seatKeywords;
     ...
     * 
     */
    public List<DiscountContextType> getSeatKeywords() {
        if (seatKeywords == null) {
            seatKeywords = new ArrayList<DiscountContextType>();
        }
