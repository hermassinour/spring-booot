 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.seatavailabilityrs.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "SegmentReferences", namespace = "http://www.iata.org/IATA/2015/00/2018.1/SeatAvailabilityRS", type = SegmentReferences.class, required = false)
        })
