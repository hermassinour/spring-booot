...
@XmlSeeAlso({
    com.springboot.dto.offerpricerq.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.offerpricerq.GroupFarePreferencesType.GroupFare.FareBasis.class
})
