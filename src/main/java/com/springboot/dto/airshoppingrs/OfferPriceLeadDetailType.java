 ...
 *                     &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.1/AirShoppingRS}OriginDestinationReference"/&gt;
...
@XmlSeeAlso({
    com.springboot.dto.airshoppingrs.OfferPriceLeadType.RequestedDate.class
})
public class OfferPriceLeadDetailType {
    ...
    public static class PriceDetail {
        ...
        @XmlElementRefs({
            @XmlElementRef(name = "OriginDestinationReference", namespace = "http://www.iata.org/IATA/2015/00/2018.1/AirShoppingRS", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "SegmentReferences", namespace = "http://www.iata.org/IATA/2015/00/2018.1/AirShoppingRS", type = SegmentReferences.class, required = false)
        })
