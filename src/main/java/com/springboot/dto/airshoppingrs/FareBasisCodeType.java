...
@XmlSeeAlso({
    com.springboot.dto.airshoppingrs.FarePreferencesType.FareCodes.Code.class,
    com.springboot.dto.airshoppingrs.GroupFarePreferencesType.GroupFare.FareBasis.class
})
